...
const BusinessForm = () => {
    ...
    return ( <
        div className = "w-full" > {
            error && ( <
                div className = "mb-4 p-3 bg-red-50 border border-red-200 rounded-md text-red-600 text-sm" > { error } <
                /div>
            )
        }
        ...
        className = "sr-only" > Business Name < /label> <
        ...
        className = "sr-only" > Business Email < /label> <
        ...
        className = "sr-only" > Business Type < /label> <
