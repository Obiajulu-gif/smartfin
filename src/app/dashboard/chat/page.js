			...
			<div className="w-full max-w-4xl px-4">
				...
				<div className="mt-4 bg-white p-4 rounded-lg shadow mb-6">
					...
					>
						...
						<svg 
							className={`w-5 h-5 ml-1 transform transition-transform ${showInfo ? "rotate-180" : ""}`} 
							fill="none" 
							stroke="currentColor" 
							viewBox="0 0 24 24"
						>
					...
					{showInfo && (
						<div className="mt-4 text-sm text-gray-700 space-y-2">
							...
							<ul className="list-disc pl-5 space-y-1">
								...
								<li>Answering questions about blockchain and web3 technologies</li>
								<li>Helping with financial planning and budgeting</li>
							</ul>
							<p className="mt-2">Simply type your question or request, and our AI will assist you!</p>
						</div>
					)}
				</div>
